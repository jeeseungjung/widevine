(function () {
    ...
    function registerMouseEvents() {
        ...
        document.querySelector('.video-controls .getProperties').addEventListener(
            'click',
            function() {
            	player.getProperties();
            }
        );
        document.querySelector('.video-controls .getTracks').addEventListener(
            'click',
            function() {
            	player.getTracks();
            }
        );
        document.querySelector('.video-controls .setTrack0').addEventListener(
            'click',
            function() {
            	player.setTrack("AUDIO", 3);
            }
        );
        document.querySelector('.video-controls .setTrack1').addEventListener(
            'click',
            function() {
            	player.setTrack("AUDIO", 4);
            }
        );           
    }
    ...
    window.onload = function () {
        ...
        var config = {
            ...
            //url: 'http://hls-streamer2-dev.minutv.ee/64dfda30759c78371885b21baff4c221_1467938103web/input/ch01/index.m3u8',
            url: 'http://hls-streamer2-dev.minutv.ee/2d6870d65cd1b616ec04c107288081a9_1467970545web/vod/indur_test_lg/index.m3u8',
            //url: 'https://tungsten.aaplimg.com/VOD/bipbop_adv_fmp4_example/master.m3u8',
